...
<aside class="w-64 bg-white border-r border-gray-200 flex flex-col fixed lg:relative h-screen lg:h-auto lg:translate-x-0 transform -translate-x-full transition-all duration-300 z-50" id="sidebar">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <a href="{{ route('salon.documentation.index') }}" title="Documentation" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition {{ request()->routeIs('salon.documentation.*') ? 'bg-[#e6f0f3] text-[#003047]' : '' }}">
