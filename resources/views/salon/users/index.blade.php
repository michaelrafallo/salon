...
var roleColors = {
    'superadmin': { bg: '#dbeafe', text: '#1d4ed8', badge: '#eff6ff', badgeText: '#1d4ed8' },
    'admin': { bg: '#ffedd5', text: '#c2410c', badge: '#fff7ed', badgeText: '#c2410c' },
    'technician': { bg: '#f3e8ff', text: '#7e22ce', badge: '#faf5ff', badgeText: '#7e22ce' },
    'receptionist': { bg: '#dcfce7', text: '#15803d', badge: '#f0fdf4', badgeText: '#15803d' }
};
...
function getUserAvatar(u, size, textSize) {
    ...
    if (u.profilePhotoUrl) {
        ...
        return '<div class="' + size + ' rounded-full overflow-hidden flex-shrink-0 cursor-pointer" onclick="event.stopPropagation();previewUserPhoto(\'' + safeUrl + '\')"><img src="' + u.profilePhotoUrl.replace(/"/g, '&quot;') + '" alt="" class="w-full h-full object-cover" onerror="this.style.display=\'none\';this.parentNode.innerHTML=\'<div class=&quot;' + size + ' rounded-full flex items-center justify-center flex-shrink-0&quot; style=&quot;background-color:' + colors.bg + '&quot;><span class=&quot;' + textSize + ' font-bold&quot; style=&quot;color:' + colors.text + '&quot;>' + inits + '</span></div>\';this.parentNode.onclick=null;this.parentNode.style.cursor=\'default\'"></div>';
    }
    return '<div class="' + size + ' rounded-full flex items-center justify-center flex-shrink-0" style="background-color:' + colors.bg + '"><span class="' + textSize + ' font-bold" style="color:' + colors.text + '">' + inits + '</span></div>';
}
