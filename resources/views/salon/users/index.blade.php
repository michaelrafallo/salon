...
function getUserAvatar(u, size, textSize) {
    ...
    if (u.profilePhotoUrl) {
        return '<div class="' + size + ' rounded-full overflow-hidden flex-shrink-0"><img src="' + u.profilePhotoUrl.replace(/"/g, '&quot;') + '" alt="" class="w-full h-full object-cover" onerror="this.style.display=\'none\';this.parentNode.innerHTML=\'<div class=&quot;' + size + ' ' + colors.bg + ' rounded-full flex items-center justify-center flex-shrink-0&quot;><span class=&quot;' + textSize + ' font-bold ' + colors.text + '&quot;>' + inits + '</span></div>\'"></div>';
    }
