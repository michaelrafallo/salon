        ...
        <div id="tab-general" class="settings-tab {{ $settingsTab === 'general' ? '' : 'hidden' }}">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div class="flex items-center gap-6" id="logoUploadSection" data-upload-url="{{ route('api.salon.settings.upload-logo') }}" data-remove-url="{{ route('api.salon.settings.remove-logo') }}">
                    <div id="logoPreviewContainer" class="rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden bg-gray-50 flex-shrink-0" style="min-width:96px;min-height:96px">
                        ...
                        <img id="logoPreviewImg" src="" alt="Business Logo" class="h-auto object-contain hidden" style="max-width:160px">
                    </div>
                    <div class="flex-1">
    ...
    fileInput.addEventListener('change', function() {
        ...
        .then(function(res) {
            if (res.success && res.data && res.data.logo_url) {
                ...
                if (sidebarWrap) sidebarWrap.classList.remove('bg-[#003047]', 'w-16', 'h-16');
            } else {
    ...
    removeBtn.addEventListener('click', function() {
        ...
        .then(function(res) {
            if (res.success) {
                ...
                if (sidebarWrap) sidebarWrap.classList.add('bg-[#003047]', 'w-16', 'h-16');
            }
        })
