...
<head>
    ...
    <title>Forgot Password - Nail Salon POS</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
                <form id="forgotPasswordForm" class="space-y-6" onsubmit="handleForgotPassword(event)">
                    ...
                    <div class="text-center">
                        <a href="login.php" class="text-sm text-[#003047] hover:text-[#002535] font-medium inline-flex items-center gap-1">
    ...
    <script>
        function handleForgotPassword(event) {
            ...
            // Simulate API call (in a real application, this would be done on the server)
            setTimeout(() => {
                // Success message
                successDiv.innerHTML = `
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm mt-1">We've sent a password reset link to <strong>${email}</strong>. Please check your email inbox and follow the instructions to reset your password.</p>
                        </div>
                    </div>
                `;
                ...
                // Show back to login link more prominently
                setTimeout(() => {
